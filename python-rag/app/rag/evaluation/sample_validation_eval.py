"""Sample comparison evaluation between no-RAG and naive-RAG."""
...
from .config import SampleEvalConfig
...
from .naive_rag_eval import load_vector_store
...
async def evaluate_sample(
    ...
    """Evaluate a sample of questions using shared evaluation helpers."""
...
__all__ = ["SampleEvalConfig", "evaluate_sample", "run_sample_comparison"]